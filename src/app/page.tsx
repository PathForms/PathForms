  ...
  return (
    ...
    >
      ...
      >
        ...
        <p style={{ color: "#a0a0a0", fontSize: "clamp(12px, 1.4vw, 14px)", marginTop: "12px", textAlign: "center", maxWidth: "clamp(280px, 28vw, 380px)" }}>Rank 1 corresponds to a free group generated by a single element, for example S = {'{a}'}</p>
        </div>
        ...
        <p style={{ color: "#a0a0a0", fontSize: "clamp(12px, 1.4vw, 14px)", marginTop: "12px", textAlign: "center", maxWidth: "clamp(280px, 28vw, 380px)" }}>Rank 2 corresponds to a free group generated by two elements: S = {'{a,b}'}</p>
        </div>
        ...
        <p style={{ color: "#a0a0a0", fontSize: "clamp(12px, 1.4vw, 14px)", marginTop: "12px", textAlign: "center", maxWidth: "clamp(280px, 28vw, 380px)" }}>Rank 3 corresponds to a free group generated by three elements: S = {'{a,b,c}'}</p>
        </div>
      </div>
